---
description: Overview and conventions for all skills in this project's delivery loop.
---
...
- A clean read/write contract against `.flow/` defined in `_shared/ARTIFACT-CONTRACT.md`.
